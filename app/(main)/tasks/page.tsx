...
import {
  AlertCircle, CheckCheck, CheckCircle2, Clock,
  LayoutList, Pencil, Plus, Save, Search,
} from "lucide-react";
  ...
  const savePageTitle = () => {
    ...
    try {
      ...
      localStorage.setItem(
        TASK_NAV_PAGES_KEY,
        JSON.stringify(pages.map((p) => (p.id === taskPageId ? { ...p, name: next } : p)))
      );
    ...
    return (
      <>
        <div style={{
          ...
          <p style={{ color: "var(--color-foreground-muted)", fontSize: 16, textAlign: "center", maxWidth: 320 }}>
            Use the <strong style={{ color: "var(--color-foreground)" }}>+</strong> icon beside Tasks to create and open a new page.
          </p>
        </div>
    ...
    <>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12, flexWrap: "wrap" }}>
          {[
            { icon: <LayoutList size={12} />, label: `${stats.total} tasks`, token: "primary" },
            { icon: <CheckCircle2 size={12} />, label: `${stats.done} done`, token: "success" },
            { icon: <AlertCircle size={12} />, label: `${stats.urgent} urgent`, token: "error" },
      ...
      <Card style={{ marginBottom: 20 }}>
        <p style={{
          ...
          letterSpacing: "0.1em", color: "var(--color-foreground-muted)", marginBottom: 12,
        }}>
          New Task
        </p>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 14, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <div style={{ position: "relative", flex: "1 1 160px" }}>
          <Search size={14} style={{
            ...
            color: "var(--color-foreground-muted)", pointerEvents: "none",
          }} />
          <Input
            value={search}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {filteredTasks.length === 0 && (
            <div style={{
              ...
              color: "var(--color-foreground-muted)", fontSize: 15,
            }}>
