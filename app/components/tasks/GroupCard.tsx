...
export function GroupCard({
  groupKey, tasks, isOpen, onToggle,
  selectedTasks, taskCardProps, onSelectTask,
}: GroupCardProps) {
    ...
    <div style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 15, color: "var(--color-foreground)" }}>
            {groupKey}
          </span>
          <span style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 11, color: "var(--color-foreground-muted)", minWidth: 28 }}>
            {progress}%
          </span>
        </div>
      </button>
