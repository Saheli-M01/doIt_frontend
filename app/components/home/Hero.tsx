          ...
          <div className="relative z-10 md:max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-0 lg:px-8 w-full">
            <div className="grid lg:grid-cols-[1.3fr_0.8fr] gap-6 lg:gap-10 xl:gap-16 items-center">
              ...
              <div className="space-y-6 lg:space-y-8 px-3">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border text-xs font-semibold uppercase tracking-widest bg-zinc-100/80 dark:bg-zinc-900/60 backdrop-blur-xl border-zinc-300/50 dark:border-white/10 text-blue-700 dark:text-blue-300 transition-colors duration-300">
                ...
                <div className="space-y-3 lg:space-y-4">
                  ...
                  <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 max-w-full leading-relaxed transition-colors duration-300">
                    Experience the next evolution of productivity. DoIt syncs your cognitive load with high-performance neural tasking, turning chaos into crystalline execution.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  {user ? (
                    ...
                    <>
                      ...
                      <Link
                        href="/auth/login"
                        className="inline-flex items-center justify-center gap-2 px-6 py-2 rounded-full border font-bold text-base transition-all bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border-zinc-300 dark:border-white/10 text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-white/5"
                      >
                        Sign in
                      </Link>
                    </>
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {heroFeatures.map((feature, idx) => (
                    ...
                    >
                      ...
                      <span className="font-medium text-sm text-zinc-900 dark:text-white transition-colors duration-300">{feature.title}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="relative  h-[450px] lg:h-[550px] flex justify-end">
                ...
                {/* Decorative Glows */}
                <div className="absolute -top-20 -left-20 w-64 h-64 bg-primary/10 dark:bg-primary/20 blur-[100px] rounded-full pointer-events-none transition-opacity duration-300" />
                <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-blue-600/10 dark:bg-[#005087]/20 blur-[100px] rounded-full pointer-events-none transition-opacity duration-300" />
              </div>
            </div>
          </div>
